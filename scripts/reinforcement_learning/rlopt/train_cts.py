...
parser.add_argument(
    ...
    type=float,
    default=0.75,
    help="Ratio of teacher environments to total environments.",
)
...
from rlopt.agent.cts.cts import CTSPPO
...
def main(
    ...
    if args_cli.resume_training:
        ...
        log_root_path = os.path.join("logs", "cts", args_cli.task)
    ...
    # directory for logging into
    log_dir = os.path.join("logs", "cts", args_cli.task, log_time_note)
